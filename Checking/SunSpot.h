...
public:
    ...
    SunSpot(int vec[] , int output = 0 , unsigned PredHor = 1 , unsigned InDim = 1)
    {
    ...
    SunSpot(SunSpot const& );
    SunSpot& operator= (SunSpot const&);
    ...
    friend ostream& operator<<( ostream& Out, const SunSpot& ssn );
